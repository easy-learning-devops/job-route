  ...
  return (
    <div className="post-job-container">
      ...
      >
        ...
        <p style={{ color: "#4a1de9", fontWeight: 500 }}>
          Need Help? Call us at 08069824660
        </p>
      </div>
      <form onSubmit={onSubmit}>
            ...
            <div className="btn-group">
              <button
                ...
                className={`btn-option ${
                  data.jobType === "Full Time" ? "selected" : ""
                }`}
                onClick={() =>
              ...
              <button
                type="button"
                className={`btn-option ${
                  data.jobType === "Part Time" ? "selected" : ""
                }`}
                onClick={() =>
        ...
        <div className="form-section">
          ...
          <div className="form-group">
            <label>
              Total Experience of Candidate <span className="required">*</span>
            </label>
            <div className="btn-group">
              <button
                type="button"
                className={`btn-option ${
                  data.experienceRequired === "Any" ? "selected" : ""
                }`}
                onClick={() =>
                  setFormData({ ...formData, experienceRequired: "Any" })
                }
              >
                Any
              </button>
              <button
                type="button"
                className={`btn-option ${
                  data.experienceRequired === "Fresher Only" ? "selected" : ""
                }`}
                onClick={() =>
                  setFormData({
                    ...formData,
                    experienceRequired: "Fresher Only",
                  })
                }
              >
                Fresher Only
              ...
              <button
                type="button"
                className={`btn-option ${
                  data.experienceRequired === "Experienced Only"
                    ? "selected"
                    : ""
                }`}
                onClick={() =>
          ...
          <div className="form-group">
            <label>
              Monthly In-hand Salary <span className="required">*</span>
            </label>
            ...
            <div className="radio-group">
              <label>
                <input
                  type="radio"
                  name="hasBonus"
                  checked={data.hasBonus === true}
                  onChange={() => setFormData({ ...formData, hasBonus: true })}
                />{" "}
                Yes
              </label>
              <label>
                <input
                  type="radio"
                  name="hasBonus"
                  checked={data.hasBonus === false}
                  onChange={() => setFormData({ ...formData, hasBonus: false })}
                />{" "}
                No
              </label>
            </div>
          ...
          <div className="form-group">
            <label>
              Job Info / Job Description <span className="required">*</span>
            </label>
            <textarea
              name="description"
            ...
            <p className="field-hint">
              Remaining characters: {350 - data.description.length}
            </p>
          </div>
          <div className="form-group">
            <label>Skills</label>
            ...
            />
            <p className="field-hint">Add relevant skills for this job.</p>
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div className="form-row">
            <div className="form-group">
              <label>
                Job Timings <span className="required">*</span>
              </label>
              <textarea
                name="jobTimings"
                value={data.jobTimings}
                onChange={onChange}
                required
              />
            </div>
            <div className="form-group">
              <label>
                Interview Details <span className="required">*</span>
              </label>
              <textarea
                name="interviewDetails"
                value={data.interviewDetails}
                onChange={onChange}
                required
              />
            </div>
        ...
        <div className="form-section">
          ...
          <div className="form-row">
            <div className="form-group">
              <label>
                Contact Person Profile <span className="required">*</span>
              </label>
              <select
                name="contactPersonProfile"
                value={data.contactPersonProfile}
                onChange={onChange}
              >
            ...
            <div className="form-group">
              <label>
                Size of Organization <span className="required">*</span>
              </label>
              <select
